...
const ManagerDasboardSideBar: React.FC<Props> = ({ children }) => {
    const input = [
        { name: 'Task', key: '/Manager/Dashboard' },
        { name: 'User', key: '/Manager/UserList' },
    ];
...
export default ManagerDasboardSideBar;
