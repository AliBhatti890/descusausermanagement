        ...
        <div className="grid grid-cols-2 w-full ">
          <div className="grid gap-3">
            <div className="flex justify-between  w-full ">
              <h2 className="text-lg font-bricolage font-bold">{mode} Task</h2>
            </div>
            <form onSubmit={handleSubmit} className="grid gap-3">
              {organizationInputs.map((input) => (
                ...
                >
                  ...
                  >
                    {input.name === "IsActive" ? "Active" : input.name}
                  </label>
                  ...
                  {input.type === "dropdown" ? (
                    ...
                    <input
                      ...
                      type={input.type}
                      checked={
                        organization[input.key as keyof organizations] === "Y"
                          ? true
                          : false
                      }
                      onChange={(e) => {
                        handleChange(input.key, e.target.checked ? "Y" : "N");
                      }}
